package com.mj.microservice.core.indecator;
...
public final class HttpServiceHealthIndicator implements HealthIndicator {
    ...
    public HttpServiceHealthIndicator(String serviceUrl, HttpStatus httpStatusToCheck) {
